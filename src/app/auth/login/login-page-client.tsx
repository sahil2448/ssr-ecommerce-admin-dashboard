...
function LoginFormContent() {
  ...
  return (
    <main className="min-h-screen flex items-center justify-center p-8 bg-gradient-to-br from-muted/30 via-background to-muted/20">
      <section className="w-full max-w-[420px]" aria-label="Sign in form">
        <div className="flex flex-col items-center mb-10">
          <Link href="/" className="h-14 w-14 bg-gradient-to-br from-primary/20 to-primary/5 rounded-2xl flex items-center justify-center mb-5 ring-1 ring-primary/10 hover:from-primary/30 hover:to-primary/10 transition-all duration-300" aria-label="AdminSuite - Go to home page">
        ...
        <div className="bg-card rounded-2xl border shadow-md p-7 sm:p-9">
          ...
          <div className="relative my-7" role="separator" aria-label="Or continue with">
...
export default function LoginPageClient() {
  return (
    <Suspense fallback={<div className="min-h-screen flex items-center justify-center text-muted-foreground">Loading authentication form...</div>}>
      <LoginFormContent />
    </Suspense>
  );
}